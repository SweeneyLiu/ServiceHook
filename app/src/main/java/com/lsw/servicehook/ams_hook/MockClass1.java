package com.lsw.servicehook.ams_hook;

import android.content.ComponentName;
import android.content.Intent;
import android.util.Log;

import com.lsw.servicehook.ProxyService;
import com.lsw.servicehook.ServiceHookApplication;
import com.lsw.servicehook.ServiceManager;
...
class MockClass1 implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("startService".equals(method.getName())) {
            ...
            String stubPackage = ServiceHookApplication.getContext().getPackageName();
